...
*Tweaking the layout is easy with web maps. View [Demo 5](http://mapbox.com/tutorial-sherlock/step5-responsive.html) and then read the [diff](https://github.com/mapbox/tutorial-sherlock/compare/step4-combined...step5-responsive).*
